...
- [CPU_EXTREME_FOLLOWUP_2026-08-25.md](CPU_EXTREME_FOLLOWUP_2026-08-25.md) (2026-08-25) — runs the matrix benchmark the L3 report asked for: int4 and low-precision KV measured as losses on this AVX2 box, batching as a ~6x aggregate win, and a new opt-in head-only int8 mode (+16% at near-fp32 fidelity).
- [CPU_L3_EXTREME_OPTIMIZATION_REPORT_2026-08-25.md](CPU_L3_EXTREME_OPTIMIZATION_REPORT_2026-08-25.md) (2026-08-25) — CPU cache-fit analysis, measured int8 gains, and an extreme-optimisation plan covering int4, KV precision, batching, and packed kernels.
